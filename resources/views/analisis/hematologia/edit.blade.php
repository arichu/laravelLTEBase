        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">@lang('hematologia.edittitle')</div>
                    <div class="panel-body">
                        @include('layouts.partials.error')
                        {!! Form::model($hematologia, array('route' => array('hematologia.update', $hematologia->id), 'method' =>
                        'put')) !!}
                        <div>
